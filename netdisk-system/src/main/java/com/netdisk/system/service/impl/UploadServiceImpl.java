...
import com.netdisk.common.enums.TransferEnum;
...
import com.netdisk.system.mapper.TransferMapper;
import com.netdisk.system.pojo.Data;
import com.netdisk.system.pojo.Transfer;
import com.netdisk.system.service.FileService;
import com.netdisk.system.service.IUploadService;
import com.netdisk.common.utils.Redis.RedisUtil;
import com.netdisk.common.utils.upload.UploadUtil;
...
public class UploadServiceImpl implements IUploadService {
    ...
    public FileChunkResultDTO checkChunkExist(FileChunkDTO chunkDTO) {
        ...
        if (uploaded != null && uploaded.size() == chunkDTO.getTotalChunks() && exists) {
            ...
            //根据MD5查询file
            com.netdisk.system.pojo.File sourceFile = fileMapper
                    .selectOne(new QueryWrapper<com.netdisk.system.pojo.File>().eq("md5", fileMd5));
    ...
    public boolean mergeChunk(String fileMd5, String fileName, Integer totalChunks, Long totalSize) throws IOException {
        ...
        if (mergeChunks(fileMd5, fileName, totalChunks)) {
            ...
            com.netdisk.system.pojo.File sourceFile = new com.netdisk.system.pojo.File(fileMd5, "url", userId, new Date(),
